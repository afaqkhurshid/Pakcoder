<header
  ...
  class="sticky top-0 flex w-full border-gray-200 bg-white lg:border-b" style="z-index: 999;"
>
  <div
    ...
    >
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <span
                      class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white"
                    ></span>
                  </span>

                  <span class="block">
                    <span
                      class="text-theme-sm mb-1.5 block text-gray-500"
                    >
                    ...
                    <span
                      class="text-theme-xs flex items-center gap-2 text-gray-500"
                    >
                      <span>Project</span>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <span
                      class="bg-error-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white"
                    ></span>
                  </span>
      ...
      >
        ...
        >
          <div>
            <span
              class="text-theme-sm block font-medium text-gray-700"
            >
              Musharof Chowdhury
            </span>
            <span
              class="text-theme-xs mt-0.5 block text-gray-500"
            >
          ...
          {{-- <a href="{{ route('logout') }}" class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700" >
            <svg class="fill-gray-500 group-hover:fill-gray-700" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <form action="{{ route('logout') }}" method="POST">
              @csrf
              <button type="submit" class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700">
