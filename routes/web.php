...
Route::get('/portfolio/{slug?}/{pname?}', [PortfolioController::class, 'index'])->name('portfolio');
Route::get('/stacks/{slug?}/{pname?}', [PortfolioController::class, 'projectStacks'])->name('stacks');
